...
* pve01 (Proxmox Host 1)
    ...
    * `wk-01` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 12GB ECC RAM, 32GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk.
* pve02 (Proxmox Host 2)
    ...
    * `wk-02` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 12GB ECC RAM, 32GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk.
* pve03 (Proxmox Host 3)
    * `cp-03` (Control Plane Node): 2 vCPUs (Host-Passthrough), 7GB ECC RAM, 32GB VirtIO Boot Storage.
    * `wk-03` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 12GB ECC RAM, 32GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk.
---
