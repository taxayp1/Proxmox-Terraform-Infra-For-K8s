...
* pve01 (Proxmox Host 1)
    ...
    * `wk-01` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 24GB ECC RAM, 50GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk for Longhorn.
* pve02 (Proxmox Host 2)
    ...
    * `wk-02` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 21GB ECC RAM, 50GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk for Longhorn.
* pve03 (Proxmox Host 3)
    * `cp-03` (Control Plane Node): 2 vCPUs (Host-Passthrough), 8GB ECC RAM, 32GB VirtIO Boot Storage.
    * `wk-03` (Worker Compute Node): 2 vCPUs (Host-Passthrough), 21GB ECC RAM, 50GB Boot Disk(1st M2) + 256GB(2nd M2) Dedicated Storage Disk for Longhorn.
---
